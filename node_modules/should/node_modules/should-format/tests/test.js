...
it('should format primitive wrappers', function() {
  assert.equal(format(Number(10)), 'Number { [[PrimitiveValue]]: 10 }');
  assert.equal(format(Boolean(true)), 'Boolean { [[PrimitiveValue]]: true }');
  assert.equal(format(String('abc')), 'String { [[PrimitiveValue]]: \'abc\' }');
});
